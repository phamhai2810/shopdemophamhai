		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="lv-editorial-text-block lv-content-push-list__content">
						<h3 class="lv-editorial-text-block__title heading-s heading-s-desktop">{{$menu->name}}</h3> 
						<div class="lv-editorial-text-block__ctas">
							<div>
								<a href="" class="lv-smart-link -default">Khám Phá Lựa Chọn</a>
							</div>
						</div>
					</div>
				</div>
